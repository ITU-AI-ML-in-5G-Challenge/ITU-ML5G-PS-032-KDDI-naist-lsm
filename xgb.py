...
config.read('config/xgb_config.ini')
...
class PreProcessing:
    ...
    def dump(self, filename='/tmp/xgb_transfer.bin'):
        with open(filename, 'wb') as f:
            joblib.dump(self.transfermer, f)

    def load(self, filename='/tmp/xgb_transfer.bin'):
...
class Environment:
    def train(self):
        ...
        joblib.dump(model, f"{model_path}/xgb.bin")
    ...
    def test(self):
        ...
        model = joblib.load(f"{model_path}/xgb.bin")
