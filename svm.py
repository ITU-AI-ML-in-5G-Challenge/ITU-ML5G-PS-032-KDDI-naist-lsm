...
class PreProcessing:
    ...
    def dump(self, filename='/tmp/svm_transfer.bin'):
        with open(filename, 'wb') as f:
            joblib.dump(self.transfermer, f)

    def load(self, filename='/tmp/svm_transfer.bin'):
...
class Environment:
    def train(self):
        ...
        joblib.dump(model, f"{model_path}/svm.bin")
    ...
    def test(self):
        ...
        model = joblib.load(f"{model_path}/svm.bin")
